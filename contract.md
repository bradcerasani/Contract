...
We test our work in current versions of all major desktop browsers including those made by Apple (Safari), Google (Chrome), Microsoft (Internet Explorer), Mozilla Firefox and Opera. We will not test versions of Internet Explorer 9 or earlier, nor will we test other antiquated browsers unless you specify otherwise. If you need an enhanced design for an older browser, we can provide a separate estimate for that.
...
3rd party products and services like domain name registration, website hosting, and email hosting are _not_ included in the website design and development fee. We do not markup these products and services; our estimates are based on our cost + current exchange rates, if applicable.
